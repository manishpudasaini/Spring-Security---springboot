...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public JwtFilter(JwtService jwtService, UserInfoUserDetailService userInfoUserDetailService) {
        this.jwtService = jwtService;
        this.userInfoUserDetailService = userInfoUserDetailService;
    }
    ...
    protected void doFilterInternal(
        ...
        //check if it is not null & start with bearer
